...
- Das Skript generiert ein zufälliges Passwort und gibt es **einmalig in der Browser-Konsole** aus.
- Es wird nur der SHA-256-Hash im LocalStorage gespeichert — kein Klartext im Code.
