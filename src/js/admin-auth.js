...
(function(){
  ...
  // Demo token — überschreibbar über localStorage ('optix-admin-token').
  // In Produktion niemals im Client hartcodieren, sondern serverseitig prüfen.
  const demoToken = (function(){
    try{ const t = localStorage.getItem('optix-admin-token'); return t || 'admindemo'; }catch(e){ return 'admindemo'; }
  })();
